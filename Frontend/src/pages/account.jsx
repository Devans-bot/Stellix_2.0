...
const Account = ({ user }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-start overflow-hidden z-20 min-h-screen bg-[#0F0E15] p-6 w-full relative">
      {/* User info */}
     ...
     <div className='md:ml-40 flex flex-col  gap-5'>
      ...
      {/* Boards Preview */}
      <div ref={boardsRef} className="w-full ">
        <BoardsPreview />
      </div>
     </div>
