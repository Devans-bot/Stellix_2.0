...
useLayoutEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex  bg-black/10
  backdrop-blur-md
  border border-white/10 flex-col items-center justify-around  rounded-3xl  fixed top-3/11 left-10 h-7/12  w-19 bg-[#242424] backdrop-blur-2xl  z-50 shadow-md">
        {/* Blogger Icon */}
...
/>
  ...
  <span className="text-5xl text-gray-700">
    {user?.name ? user.name.charAt(0) : 'U'}
          ...
          <Link to="/" className="hidden md:block">
            <img src={logo} onClick={handleReload} alt="" className=' absolute -mt-2 top-0 left-12 z-10  h-2/12' />
          </Link>
  ...
  <div className="bg-black/70 backdrop-blur-md w-7 h-7 rounded-full flex items-center justify-center 
  text-white font-semibold text-[22px] leading-none 
  active:scale-110 transition-transform duration-200 ease-out">
😃</div>
